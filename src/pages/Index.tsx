...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-[#06b6d4]/5 data-grid bg-noise">
      <div className="max-w-6xl mx-auto space-y-6 p-6">
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#06b6d4] to-[#06b6d4] mb-2">
          Welcome back!
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="futuristic-border glow-hover backdrop-blur-sm shadow-xl relative overflow-hidden">
          ...
          <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-bl from-[#06b6d4]/10 to-transparent rounded-bl-full"></div>

          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Total Posts</CardTitle>
            <BarChart3 className="h-4 w-4 text-[#06b6d4] drop-shadow-glow animate-pulse" />
          </CardHeader>
          <CardContent>
            <div className="relative">
              <div className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#06b6d4] to-[#06b6d4] animate-pulse-glow">
                {postsLoading ? "..." : totalPosts}
              </div>
              {/* Progress bar visual */}
              <div className="mt-2 h-1 bg-muted rounded-full overflow-hidden">
                <div
                  className="h-full bg-gradient-to-r from-[#06b6d4] to-[#06b6d4] rounded-full animate-data-pulse"
